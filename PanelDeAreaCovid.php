    ...
    <body>
        ...
        <div class="panel">
            ...
            <div class="crud">
                ...
                <div class="acciones">
                <div class="crear">
                <a href="AreaCovidInsertar.php" class="boton"><i class="fas fa-plus"></i></a>
                </div>
                <div class="leer">
                <a href="PanelDeAreaCovid.php" class="boton"><i class="fas fa-book-open"></i></a>
                </div>
                <div class="actualizar">
                <a href="AreaCovidActualizar.php" class="boton"><i class="far fa-edit"></i></a>
                </div>
                <div class="eliminar">
                <a href="AreaCovidEliminar.php" class="boton"><i class="fas fa-trash-alt"></i></a>
                </div>
                </div>
            </div>
            ...
            <!-- Modal para modificacion o edicion -->
                     <table class=" editar_tabla table table-hover table-condensed table-bordered" >
                       ...
                       $sql1="SELECT * FROM INV_AREACOVID
                       LEFT JOIN
                       PRESENTACIONES
                       ON
                       INV_AREACOVID.ID_Presentacion=PRESENTACIONES.ID_Presentacion";
                      $recurso1=sqlsrv_query($conn, $sql1);
                       while ($ver=sqlsrv_fetch_array($recurso1)) {
                      $valor_0= $ver['ID_Articulo_COV'];
                        $valor_1= $ver['Nom_Articulo_COV'];
                          $valor_2= $ver['Existencia_COV'];
