    ...
    <body>
        ...
        <div class="panel">
            ...
            <div class="crud">
                ...
                <div class="acciones">
                <div class="crear">
                <a href="AreaLaboratorioInsertar.php" class="boton"><i class="fas fa-plus"></i></a>
                </div>
                <div class="leer">
                <a href="PanelDeLaboratorio.php" class="boton"><i class="fas fa-book-open"></i></a>
                </div>
                <div class="actualizar">
                <a href="AreaLaboratorioActualizar.php" class="boton"><i class="far fa-edit"></i></a>
                </div>
                <div class="eliminar">
                <a href="AreaLaboratorioEliminar.php" class="boton"><i class="fas fa-trash-alt"></i></a>
                </div>
                </div>
            </div>
            <div class="inventario">
                ...
                <table class=" editar_tabla table table-hover table-condensed table-bordered" >
                  ...
                  $sql1="SELECT * FROM INV_LABORATORIO
                  LEFT JOIN
                  PRESENTACIONES
                  ON
                  INV_LABORATORIO.ID_Presentacion=PRESENTACIONES.ID_Presentacion";
                 $recurso1=sqlsrv_query($conn, $sql1);
                  while ($ver=sqlsrv_fetch_array($recurso1)) {
                 $valor_0= $ver['ID_Articulo_LAB'];
                   $valor_1= $ver['Nom_Articulo_LAB'];
                     $valor_2= $ver['Existencia_LAB'];
