...
<html lang="es">
    ...
    <body style="background-color: rgb(68, 118, 212);">
        ...
        <div class="panel">
            ...
            <a href="Registro_Insumos\registro_covid.php" class="generarReporte"><i class="far fa-file-alt"></i></a>
            </div>
            <div class="usuario">
            <div class="crud">
            <br></br>
            ...
            <!-- Modal para modificacion o edicion -->
             <form action="COVID_AREA_BD.php" method="post">
