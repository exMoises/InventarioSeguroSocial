...
function ALTA_LIMPIEZA($ID_ARTICULO,$ARTICULO,$CANTIDAD,$PRE,$PRESENTACION){
  ...
  $sql2="insert into almacen (ID_Articulo,Articulo,Existencia,ID_Presentacion,ID_Area) values('$ID_ARTICULO','$ARTICULO','$CANTIDAD','$PRE','area04')";
   ...
   if (mysqli_query($conexion,$sql1)){
     ...
     if($recurso2 != false){
       Header("Location:AreaLaboratorioInsertar.php");
     }else{
...
function BAJA_LIMPIEZA($ID_ARTICULO){
  ...
  include("Conexion.php");
   ...
   if (mysqli_query($conexion,$sql)){
     Header("Location:AreaLaboratorioActualizar.php");
     return true;
   }else{
     echo "<div> <h3> LO SIENTO NO SE REGISTRO</h3></div>";
   }
