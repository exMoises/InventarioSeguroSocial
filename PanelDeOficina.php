    ...
    <body>
        ...
        <div class="panel">
            ...
            <div class="crud">
                ...
                <div class="leer">
                <a href="PanelDeOficina.php" class="boton"><i class="fas fa-book-open"></i></a>
                </div>
                <div class="actualizar">
                <a href="AreaOficinaActualizar.php" class="boton"><i class="far fa-edit"></i></a>
                </div>
                <div class="eliminar">
                <a href="AreaOficinaEliminar.php" class="boton"><i class="fas fa-trash-alt"></i></a>
                </div>
                </div>
            </div>
            <div class="inventario">
                ...
                <table class=" editar_tabla table table-hover table-condensed table-bordered" >
                  ...
                  $sql1="SELECT * FROM INV_OFICINA
                  LEFT JOIN
                  PRESENTACIONES
                  ON
                  INV_OFICINA.ID_Presentacion=PRESENTACIONES.ID_Presentacion";
                 $recurso1=sqlsrv_query($conn, $sql1);
                  while ($ver=sqlsrv_fetch_array($recurso1)) {
                 $valor_0= $ver['ID_Articulo_OF'];
                   $valor_1= $ver['Nom_Articulo_OF'];
                     $valor_2= $ver['Existencia_OF'];
