...
<head>
  ...
  <body onLoad="Lista()">
  <a href="../AreaCovidActualizar.php" class="regresar"><i class="fas fa-undo-alt"></i> Regresar</a><br></br><br/>
    <form>
    <h1>Generar reportes de área covid</h1>	<br/>
...
<script type="text/javascript">
  area = 'covid';
  i = 0;
  Listarticulos = JSON.parse('<?php echo json_encode($Lista = getArticulo($conn,"covid")); ?>');
  Listarticulos.sort
