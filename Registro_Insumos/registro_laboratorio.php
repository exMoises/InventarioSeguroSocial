...
<head>
  ...
  <body onLoad="Lista()">
  <a href="../AreaLaboratorioActualizar.php" class="regresar"><i class="fas fa-undo-alt"></i> Regresar</a><br></br><br/>
    <form>
    <h1>Generar reportes del área de laboratorio</h1><br/>
...
<script type="text/javascript">
  area = 'laboratorio';
  i = 0;
  Listarticulos = JSON.parse('<?php echo json_encode($Lista = getArticulo($conn,"laboratorio")); ?>');
  Listarticulos.sort
