...
<head>
  ...
  <body onLoad="Lista()">
  <a href="../AreaUrgenciaActualizar.php" class="regresar"><i class="fas fa-undo-alt"></i> Regresar</a><br></br><br/>
    <form>
    <h1>Generar reportes del área de urgencias</h1><br/>
...
<script type="text/javascript">
  area = 'urgencia';
  i = 0;
  Listarticulos = JSON.parse('<?php echo json_encode($Lista = getArticulo($conn,"urgencias")); ?>');
  Listarticulos.sort
