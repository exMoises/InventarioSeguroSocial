...
<head>
  ...
  <body onLoad="Lista()">
  <a href="../AreaLimpiezaActualizar.php" class="regresar"><i class="fas fa-undo-alt"></i> Regresar</a><br></br><br/>
    <form>
    <h1>Generar reportes del área de limpieza</h1>	<br/>
...
<div class="tabla">
	<table id="ListaDeInsumos">
	    <caption>Tabla de insumos</caption>
       <tr>
...
<script type="text/javascript">
  area = 'limpieza';
  i = 0;
  Listarticulos = JSON.parse('<?php echo json_encode($Lista = getArticulo($conn,"limpieza")); ?>');
  Listarticulos.sort
