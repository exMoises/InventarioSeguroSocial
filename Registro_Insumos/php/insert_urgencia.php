...
$Id = num_registro($conn, 'reg_urgencia') + 1;
//$Id_ar = 'COV_'.$Id;

$query = "INSERT INTO `reg_urgencia`(`ID_Urgencia`, `Cantidad_Entregada_UR`, `Fecha_UR`, `ID_Aritculo`, `ID_Encargado_UR`) 
VALUES ('UR_$Id','$entrega','$fecha','$id_insumo','ecg1_UR')";
