...
$Id = num_registro($conn, 'reg_laboratorio') + 1;
//$Id_ar = 'COV_'.$Id;

$query = "INSERT INTO `reg_laboratorio`(`ID_Laboratorio`, `Cantidad_Entregada_LAB`, `Fecha_LAB`, `ID_Aritculo`, `ID_Encargado_LAB`) 
VALUES ('LAB_$Id','$entrega','$fecha','$id_insumo','ecg1_lab')";
