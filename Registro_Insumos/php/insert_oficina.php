...
$Id = num_registro($conn, 'reg_oficina') + 1;
//$Id_ar = 'COV_'.$Id;

$query = "INSERT INTO `reg_oficina`(`ID_Oficina`, `Cantidad_Entrega_OF`, `Fecha_OF`, `ID_Aritculo`, `ID_Encargado_OF`) 
VALUES ('OF_$Id','$entrega','$fecha','$id_insumo','ecg1_OF')";
