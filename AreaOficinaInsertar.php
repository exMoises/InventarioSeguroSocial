    ...
    <body style="background-color: rgb(68, 118, 212);">
        ...
        <div class="panel">
            ...
            <div class="inventario">
                <h2>Inserte aquí los artículos para el área oficina</h2><br/>
            	     <form action="OFICINA_AREA_BD.php" method="post">
                         <label for="ARTICULO" >Nombre:</label>
                         <input type="text" id="ARTICULO" name="ARTICULO" placeholder="Ingrese el nombre del articulo" required><br/>
                         <label for="CANTIDAD">Cantidad:</label>
                         <input type="text" id="CANTIDAD" name="CANTIDAD" placeholder="Ingrese una cantidad" onkeypress="return solonumeros(event)" onpaste="return false" required><br/>
