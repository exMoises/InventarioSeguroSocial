...
<html lang="es">
    ...
    <body style="background-color: rgb(68, 118, 212);">
        ...
        <div class="panel">
            ...
            <a href="Registro_Insumos/registro_urgencia.php" class="generarReporte"><i class="far fa-file-alt"></i></a>
            </div>
            <div class="usuario">
            <div class="crud">
            <br></br>
            ...
            <div class="inventario">
                <h2>Área Urgencias</h2>
                <br></br>
                <div id="tabla"></div>
              </div>

            <!-- Modal para modificacion o edicion -->
             <form action="URGENCIA_AREA_BD.php" method="post">
