...
<html lang="es">
    ...
    <body  style="background-color: rgb(68, 118, 212);">
        ...
        <div class="panel">
            ...
            <a href="Registro_Insumos/registro_laboratorio.php" class="generarReporte"><i class="far fa-file-alt"></i></a>
            </div>
            <div class="usuario">
            <div class="crud">
            <br></br>
            ...
            <div class="inventario">
                <h2>Área Laboratorio</h2>
                <br></br>
                <div id="tabla"></div>
            </div>
            <!-- Modal para modificacion o edicion -->
             <form action="Laboratorio_AREA_BD.php" method="post">
            <div class="modal fade" id="modaleditar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">

                    <h3 class="modal-title" id="myModalLabel">Modifica tu artículo</h3>
                  </div>
                  <div class="modal-body">
                    <div class="form-groud">
                      ...
                      <input type="hidden" class="form-control" id="ID_ARTICULO_AC" name="ID_ARTICULO_AC">
                        ...
                        <div class="form-groud">
                        <label for="PRESENTACION_AC">Presentacion:</label>
...
$(document).ready(function(){
    $('#tabla').load('Laboratorio_TABLA.php');
  });
</script>
